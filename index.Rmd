...
* if we actually put the data into the matrix container, we would throw out lots of interesting pieces.
...
* the key could include single or multiple columns
...
Join other tables using the key
...
ground breaking for time series
...
## Data pipelines.red[<sup>1,</sup><sup>2</sup>]
### break up a big problem into manageable pieces

.footnote[
.red[1.] Buja, A., Asimov, D., Hurley G., & McDonald J. (1988) Elements of a viewing piepline for data analysis. *Dynamic Graphics of Statistics* <br>
.red[2.] Wickham, H., Lawrence, M., Cook, D. et al. (2009) The plumbing of interactive graphics. *Computational Statistics* **(24)**207
]
...
* Rectangular structure: heterogeneous data type, multiple measured and grouping variables, implict missing values, and etc.
...
* A data pipeline that supports thinking of operations on the data variables
...
## .blue[Visualisation of time series with nested and crossed factors]

<br>
<br>
.middle[
.pull-left[
<img src="img/nesting.png" width = 280>
]
.pull-right[
<img src="img/crossing.png" width = 280>
]
]
